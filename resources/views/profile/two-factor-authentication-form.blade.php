<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Lorsque l\'authentification à deux facteurs est activée, vous serez invité à saisir un code sécurisé et aléatoire lors de l\'authentification. Vous pouvez récupérer ce code à partir de l\'application Google Authenticator de votre téléphone.') }}
            </p>
        </div>
